  ...
  <article  itemscope itemtype="https://schema.org/HowTo" style="margin:2rem;">
    ...
    <ol class="steps" itemprop="step" itemscope itemtype="https://schema.org/ItemList">
      <li itemprop="itemListElement" itemscope itemtype="https://schema.org/HowToStep">
        ...
        <div class="step-body">
          <strong itemprop="name">Get your JWT token</strong>
          <span itemprop="text">Find it in your API response, browser DevTools (Application → Local Storage or Cookies),
      ...
      <li itemprop="itemListElement" itemscope itemtype="https://schema.org/HowToStep">
        ...
        <div class="step-body">
          <strong itemprop="name">Paste it into the input panel</strong>
          <span itemprop="text">Copy the entire token — including all three parts and both dots — and paste it into
      ...
      <li itemprop="itemListElement" itemscope itemtype="https://schema.org/HowToStep">
        ...
        <div class="step-body">
          <strong itemprop="name">Click Decode</strong>
          <span itemprop="text">Press the Decode button (or hit Ctrl+Enter). The JWT parser immediately splits
      ...
      <li itemprop="itemListElement" itemscope itemtype="https://schema.org/HowToStep">
        ...
        <div class="step-body">
          <strong itemprop="name">Read your claims</strong>
          <span itemprop="text">Inspect the decoded output. Unix timestamps like <code>exp</code> and <code>iat</code>
...
<span class="c-kw">def</span> <span class="c-fn">decode_jwt</span>(token):
  ...
  <section style="margin:2rem;"  itemscope itemtype="https://schema.org/FAQPage">
    ...
    <div class="faq-item" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
      <details>
        <summary class="faq-q">
          <span itemprop="name">What is the difference between a JWT decoder and jwt.io?</span>
          <span class="faq-chevron">›</span>
        </summary>
        <div class="faq-a" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
          <span itemprop="text">jwt.io is the official reference tool from Auth0. Our JWT decoder does the same
    ...
    <div class="faq-item" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
      <details>
        <summary class="faq-q">
          <span itemprop="name">Can I decode a refresh token?</span>
          <span class="faq-chevron">›</span>
        </summary>
        <div class="faq-a" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
          <span itemprop="text">It depends on the auth provider. Some providers issue refresh tokens as
    ...
    <div class="faq-item" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
      <details>
        <summary class="faq-q">
          <span itemprop="name">How do I decode a JWT in Flutter or Dart?</span>
          <span class="faq-chevron">›</span>
        </summary>
        <div class="faq-a" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
          <span itemprop="text">Use the <code>dart_jsonwebtoken</code> package from pub.dev.
    ...
    <div class="faq-item" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
      <details>
        <summary class="faq-q">
          <span itemprop="name">What does "decode JWT token online" actually do?</span>
          <span class="faq-chevron">›</span>
        </summary>
        <div class="faq-a" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
          <span itemprop="text">It splits the token by the dot separator, takes the first two parts
    ...
    <div class="faq-item" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
      <details>
        <summary class="faq-q">
          <span itemprop="name">Why does my token fail to decode?</span>
          <span class="faq-chevron">›</span>
        </summary>
        <div class="faq-a" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
          <span itemprop="text">The most common reasons are: (1) the token is an opaque token, not a JWT —
    ...
    <div class="faq-item" itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
      <details>
        <summary class="faq-q">
          <span itemprop="name">How do I decode a JWT access token from OAuth2 / OpenID Connect?</span>
          <span class="faq-chevron">›</span>
        </summary>
        <div class="faq-a" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
          <span itemprop="text">OAuth2 access tokens from providers like Google, Microsoft, Okta, and Auth0
