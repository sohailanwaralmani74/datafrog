...
<div class="page-container" style="max-width: 900px; margin: 0 auto; padding: 2.5rem 1.5rem; line-height: 1.7; color: var(--text-primary);">
  <header style="margin-bottom: 2.5rem; border-bottom: 1px solid var(--border-default); padding-bottom: 1.5rem;">
    <h1 style="font-size: 2.25rem; font-weight: 700; margin-bottom: 0.5rem; color: var(--text-primary);">Terms of Service</h1>
  ...
  <section style="margin-bottom: 2rem;">
    <h2 style="font-size: 1.5rem; font-weight: 600; margin-bottom: 1rem; color: var(--text-primary);">7. Changes to Terms</h2>
    <p>We reserve the right to modify these Terms of Service at any time. Continued use of the Website following any changes constitutes your acceptance of the updated terms.</p>
  </section>

  <section style="margin-bottom: 2rem;">
    <h2 style="font-size: 1.5rem; font-weight: 600; margin-bottom: 1rem; color: var(--text-primary);">8. Contact Information</h2>
    <p>For questions regarding these Terms of Service, please visit our <a href="/contact-us" style="color: var(--primary);">Contact Page</a> or reach out to <code>support@datafrog.tools</code>.</p>
  </section>
</div>
