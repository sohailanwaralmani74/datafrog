...
<article id="tool-content" style="max-width:900px;margin:40px auto;padding:10px 20px;line-height:1.7;font-family:Arial,sans-serif;">
  ...
  <section id="faq">
    ...
    <h3>Is Excel formatting (colors, fonts, formulas) preserved?</h3>
    ...
    <h3>Can I edit the data before converting to CSV?</h3>
    ...
    <h3>Is this XLSX to CSV converter really free?</h3>
