---
layout: main
title: "Disclaimer | DataFrog.tools"
...
<div class="page-container" style="max-width: 900px; margin: 0 auto; padding: 2.5rem 1.5rem; line-height: 1.7; color: var(--text-primary);">
  <header style="margin-bottom: 2.5rem; border-bottom: 1px solid var(--border-default); padding-bottom: 1.5rem;">
    <h1 style="font-size: 2.25rem; font-weight: 700; margin-bottom: 0.5rem; color: var(--text-primary);">Disclaimer</h1>
  ...
  <section style="margin-bottom: 2rem;">
    <h2 style="font-size: 1.5rem; font-weight: 600; margin-bottom: 1rem; color: var(--text-primary);">Contact</h2>
    <p>If you have questions regarding this Disclaimer, please reach out via our <a href="/contact-us" style="color: var(--primary);">Contact Page</a>.</p>
  </section>
</div>
